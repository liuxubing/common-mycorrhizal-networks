...
SeedlingSurvivalmean$se<-aggregate(survival~SPcode+MeshSize,data=SeedlingSurvival,sd)$survival/sqrt(aggregate(survival~SPcode+Meshsize,data=SeedlingSurvival,length)$survival)
...
prop.test(x=c(sum(CAL.L.SeedlingSurvival$survival),sum(CAL.S.SeedlingSurvival$survival)),n=c(48,48),alternative = "two.sided")
...
prop.test(x=c(sum(CCO.L.SeedlingSurvival$survival),sum(CCO.S.SeedlingSurvival$survival)),n=c(48,48),alternative = "two.sided")
...
prop.test(x=c(sum(OGL.L.SeedlingSurvival$survival),sum(OGL.S.SeedlingSurvival$survival)),n=c(48,48),alternative = "two.sided")
...
prop.test(x=c(sum(SSU.L.SeedlingSurvival$survival),sum(SSU.S.SeedlingSurvival$survival)),n=c(48,48),alternative = "two.sided")
...
t.test(ECM.SeedlingSurvival.total.L$survival1,ECM.SeedlingSurvival.total.S$survival1)
...
t.test(AM.SeedlingSurvival.total.L$survival1,AM.SeedlingSurvival.total.S$survival1)
